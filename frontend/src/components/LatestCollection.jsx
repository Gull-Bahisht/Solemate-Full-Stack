        ...
        <div className='my-10'>
            ...
            <div className='text-center py-8 text-3xl'>
                ...
                <p className='w-3/4 m-auto text-xs sm:text-sm md:text-base text-gray-600'>
                    ...
                    Sunt inventore iusto enim. Nam vel asperiores minus explicabo
                    incidunt ipsam corrupti ut, quis voluptate excepturi cum
                    exercitationem ratione, voluptas quasi! Enim?
                </p>
