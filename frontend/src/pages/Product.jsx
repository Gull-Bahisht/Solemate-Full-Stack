        ...
        <div className="flex-1">
          ...
          <button
            onClick={() =>
              addToCart(
                productData._id,
                productData.sizes.length > 0 ? size : "no-size",
              )
            }
            className="mt-6 bg-pink-600 text-white px-8 py-3 text-sm active:bg-gray-500"
          >
            ADD TO CART
          </button>
      ...
      <div className="mt-20">
        ...
        <div className="flex flex-col gap-4 border px-6 py-6 text-sm text-gray-500">
          <p>
            ...
            officiis quos voluptatem nemo asperiores libero quidem ut possimus
            nam molestias iure perferendis soluta tempora obcaecati, eaque
            consequuntur magni laborum quis.
          </p>
          <p>
            Lorem, ipsum dolor sit amet consectetur adipisicing elit. Eveniet
            soluta iusto cupiditate debitis aperiam est quidem recusandae qui,
            accusamus nesciunt sapiente eos, quae ipsa explicabo minima quam
            repellendus aliquam quia?
          </p>
        </div>
      </div>
